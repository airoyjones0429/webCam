...
// !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
// !! 如果環境變數名稱用相同的名稱  沒有用 1  2  去分別  只有先執行的攝影機可以執行
// !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
const DEVICE_PORT = process.env.DEVICE_PORT1 || 3200; // 使用環境變數 DEVICE_PORT
const DEVICE_MAC = process.env.DEVICE_MAC1 || 'video=@device_pnp_\\\\?\\usb#vid_1908&pid_2311&mi_00#7&14e0e638&0&0000#{65e8773d-8f56-11d0-a3b9-00a0c9223196}\\global'; // 使用環境變數 DEVICE_MAC

const DEVICE_DRIVER_NAME =  process.env.DEVICE_DRIVER_NAME1 || 'E:' ; //儲存影片的主機磁碟機名稱
const DEVICE_DIRECTORY =  process.env.DEVICE_DIRECTORY1 || 'hls1' ; //儲存影片的主機目錄名稱
